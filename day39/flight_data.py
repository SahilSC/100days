...
class FlightData:
    ...
    def cityinfo(self, to_iata, stop_overs = 0, via_city = departure_city):
        self.params["fly_to"]=to_iata
        self.params['max_stopovers'] = stop_overs
        self.params['fly_from'] = via_city
        ...
        for cityinfo in data:
            ...
            citydict['stop_over'] = None if stop_overs == 0 else cityinfo['route'][1]['cityFrom']
...
# a = FlightData()
# a.cityinfo(to_iata="SYD", stop_overs=0)